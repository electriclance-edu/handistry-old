...
let videoWidth = document.getElementsByClassName("input_video").clientWidth;
let videoHeight = document.getElementsByClassName("input_video").clientHeight;
...
function onResults(results) {
    ...
    canvasElement.width = document.getElementsByClassName('input_video').clientWidth;
    canvasElement.height = document.getElementsByClassName('input_video').clientHeight;
    
    canvasCtx.save();

    canvasCtx.clearRect(0, 0, canvasElement.width, canvasElement.height);
    canvasCtx.drawImage(canvaElement, 0, 0, canvasElement.width, canvasElement.height);
...
function drawOnScreen(x, y, z) { //for canvases, (0,0) is top left corner
    ...
    drawingCanvas.width = document.getElementsByClassName('drawing_container').clientWidth;
    drawingCanvas.height = document.getElementsByClassName('drawing_container').clientHeight;
